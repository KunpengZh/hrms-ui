    ...
    AppStore.getConfigData()
      .then(configData => {
        ...
        nstate.columns = [
          ...
          { key: "workerCategory", name: "员工类别", editable: false, sortable: true, width: 150 },
          { key: "department", name: "部门", editable: false, sortable: true, width: 100 },
          { key: "jobRole", name: "岗位", editable: false, sortable: true, width: 100 },
