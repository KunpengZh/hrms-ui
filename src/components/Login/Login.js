                ...
                <div className="formContainer">
                    <div className="loginHeaderContainer">
                        <div className="logoContainer">
                            <img className="hrLoginIcon" src="../../images/hrmlogo2.png" />
                        </div>
                        <div className="titleContainer">
                            <img className="sysTitle" src="../../images/hrsys.PNG" alt="" />
                            <img className="companyTitle" src="../../images/guangdacompany.PNG" alt="" />
                        </div>
                    </div>
