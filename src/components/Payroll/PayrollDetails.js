      ...
      <div className="PayrollContainer">
        <div className="PayrollBodyContainer">
          ...
          <DataGrid
            ...
            downloadTableLink={
              AppStore.getPreHostURLLink() + "/scal/downloadtable?salaryCycle=" + this.state.curYearMonth
            }
        ...
        >
          <Dialog.Body>
            <span>
              冻结结算，是指冻结当前月份的工资结算，冻结之后本月份的工资将不允许再次修改，您确认要冻结本月的工资结算吗？
            </span>
          </Dialog.Body>
          <Dialog.Footer className="dialog-footer">
            <Button onClick={() => this.setState({ showConfirm: false })}>取消</Button>
            <Button type="primary" onClick={this.handleFinalizeSalaryCalData.bind(this)}>
              确定
            </Button>
          </Dialog.Footer>
        </Dialog>
        ...
        >
          ...
          <Dialog.Footer className="dialog-footer">
            ...
            <Button type="primary" onClick={this.handleConfigTableConfirm.bind(this)}>
              确 定
            </Button>
          </Dialog.Footer>
        </Dialog>
